namespace FpsHorrorKit
{
    ...
    public class ITOLightSwitch : MonoBehaviour, IInteractable
    {
        ...
        [Header("Trigger Bağlantısı")]
        [Tooltip("Işık AÇILINCA hangi GeneralTrigger ateşlensin?")]
        public GeneralTrigger onLightOnTrigger;
        ...
        public void Interact()
        {
            ...
            if (_light.activeSelf && onLightOnTrigger != null)
                onLightOnTrigger.ManualTrigger();
