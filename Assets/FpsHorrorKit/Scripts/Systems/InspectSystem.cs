namespace FpsHorrorKit
{
    ...
    public class InspectSystem : MonoBehaviour, IInteractable
    {
        ...
        [Header("Hint UI")]
        [Tooltip("İnceleme sırasında gösterilecek UI text (Q - Bırak gibi)")]
        public GameObject inspectHint;

        [Header("Piece Counter")]
        [Tooltip("Bu obje incelenince parça sayacına eklensin mi?")]
        public bool countAsPiece = false;
        [Tooltip("Inspect bittikten kaç saniye sonra sayılsın")]
        public float pieceRegisterDelay = 2f;

        private float _startLightIntensity;
        private bool _pieceRegistered = false;
        ...
        public void Interact()
        {
            ...
            if (inspectHint != null) inspectHint.SetActive(true);
        ...
        private void StopInspection()
        {
            ...
            if (inspectHint != null) inspectHint.SetActive(false);
