namespace FpsHorrorKit
{
    ...
    public class DialogueSystem : MonoBehaviour
    {
        ...
        [Tooltip("Her satır en az bu kadar saniye ekranda kalır")] public float minLineDisplayTime = 4f;
        ...
        private IEnumerator AutoAdvanceDialogue()
        {
            while (dialoguePanel.activeSelf)
            {
                ...
                float delay = Mathf.Max(lineLength / currentAutoAdvanceSpeed, minLineDisplayTime);
        ...
        {
            if (skipInfoImage == null) yield break;
